...
CREATE TABLE user(
	id BIGINT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(40) UNIQUE NOT NULL NOT NULL,
    password CHAR(128) NOT NULL,
    lastlogout DATETIME NOT NULL DEFAULT NOW(),
    since DATETIME NOT NULL DEFAULT NOW()
);

ALTER TABLE server ADD CONSTRAINT FOREIGN KEY fk_owner(owner) REFERENCES user(id) ON DELETE CASCADE;
